...
class Dec02Test {
    ...
    fun isValid() {
        ...
        assertTrue(s.isValid(12))
        assertTrue(s.isValid(13))
        assertTrue(s.isValid(14))
        assertTrue(s.isValid(15))
        assertFalse(s.isValid(22))
    }
    ...
    fun isSillyPattern() {
        ...
        assertTrue(s.isSillyPattern("55"))
        assertTrue(s.isSillyPattern("6464"))
        assertTrue(s.isSillyPattern("123123"))
        assertFalse(s.isSillyPattern("1213"))
    }
    ...
    fun analyseRange11_22() {
        ...
        s.analyseRange(11, 22, invalidIds, validIds)
    ...
    fun analyseRange95_115() {
        ...
        s.analyseRange(95, 115, invalidIds, validIds)
    ...
    fun analyseRange998_1012() {
        ...
        s.analyseRange(998, 1012, invalidIds, validIds)
    ...
    fun analyseRange1188511880_1188511890() {
        ...
        s.analyseRange(1188511880, 1188511890, invalidIds, validIds)
    ...
    fun analyseRange222220_222224() {
        ...
        s.analyseRange(222220, 222224, invalidIds, validIds)
    ...
    fun analyseRange1698522_1698528() {
        ...
        s.analyseRange(1698522, 1698528, invalidIds, validIds)
    ...
    fun analyseRange446443_446449() {
        ...
        s.analyseRange(446443, 446449, invalidIds, validIds)
    ...
    fun analyseRange38593856_38593862() {
        ...
        s.analyseRange(38593856, 38593862, invalidIds, validIds)
